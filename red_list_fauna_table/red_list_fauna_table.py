...
import os.path
from .tablemaker import redListFauna
...
class RedListFaunaTable:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "RedListFaunaTable_{}.qm".format(locale)
        )
        ...
        self.actions = []
        self.menu = self.tr("&Red List Fauna Table")
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("RedListFaunaTable", message)
    ...
    def initGui(self):
        ...
        icon_path = ":/plugins/red_list_fauna_table/icon.png"
        self.add_action(
            icon_path,
            text=self.tr("Rote Liste Fauna Tabellen"),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr("&Red List Fauna Table"), action)
